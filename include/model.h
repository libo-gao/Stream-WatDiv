...
public:
    ...
    void initialize(int seed = static_cast<unsigned> (time(0))){
        ...
        BOOST_INT_UNIFORM = new boost::random::uniform_int_distribution<>(0, RAND_MAX);
...
private:
    ...
    int rand_seed;
    boost::mt19937 BOOST_RND_GEN;
    boost::random::uniform_int_distribution<>* BOOST_INT_UNIFORM;
    boost::normal_distribution<double> BOOST_NORMAL_DIST = boost::normal_distribution<double>(0.5, (0.5/3.0));
...
struct model{
    ...
    void generate_stream_data (int static_scale_factor, int stream_scale_factor);
